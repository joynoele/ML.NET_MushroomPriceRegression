...
namespace SellMyMushiesML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Repo\GMICodeCamp11\Data\usda_mushrooms.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.Value} | Predicted value: {predictionResult.Score}");
